    ...
    paths: {
        ...
        "/auth/refresh": {
            post: {
                ...
                description: "Uses httpOnly refreshToken cookie. Body refreshToken is optional fallback. Requires CSRF header x-csrf-token matching csrfToken cookie.",
                parameters: [
                    {
                        name: "x-csrf-token",
                        in: "header",
        ...
        "/mct-cases": {
            ...
            get: {
                ...
                description: "Role-aware listing. CORPER: own cases, DOCTOR: assigned cases, COORDINATOR/ABUJA_ADMIN/DG/SYSTEM: all.",
                security: [{ bearerAuth: [] }],
                parameters: [
                    {
                        name: "status",
        ...
        "/mct-cases/{id}/status": {
            patch: {
                ...
                description: "Transitions case state using role-based rules and writes audit logs for attempt/success/failure.",
                security: [{ bearerAuth: [] }],
                parameters: [
                    {
                        name: "id",
        ...
        "/mct-cases/{id}/verification-codes": {
            post: {
                ...
                description: "Generates a verification code for the case. In normal environments, plaintext code is not returned in API response.",
                security: [{ bearerAuth: [] }],
                parameters: [
                    {
                        name: "id",
